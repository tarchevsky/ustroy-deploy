...
interface WorkshopPagesGridProps {
  pages: PageNode[]
}

const WorkshopPagesGrid: React.FC<WorkshopPagesGridProps> = ({ pages }) => {
  // Мапим в формат, похожий на ProjectGrid
  const posts = pages.map((page) => ({
    slug: page.slug,
    title: page.title,
    featuredImage: undefined,
    path: `/workshops/${page.slug}`,
  }))
...
export default WorkshopPagesGrid
